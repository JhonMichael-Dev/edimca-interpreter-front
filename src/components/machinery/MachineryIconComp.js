...
export const MachineryIconComp = observer((props) => {
  ...
  */
    return (
        <div className="card" style={{ width: "120px", textAlign: "center", alignContent: "center", justifyContent: "center" }} title={props.machineryData.code}>
            <i className="p-overlay-badge">
                <img src={imageName} alt={props.machineryData ? imageName : "-"} className="pos-edimca-button-noLabel" style={{ width: "70px", height: "70px" }}></img>
