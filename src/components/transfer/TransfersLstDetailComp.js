...
export const TransfersLstDetailComp = observer((props) => {
  ...
  */
    ...
    let selectDestinationComp = selOrderDetail ? <TransferSelectDestinationComp handleProcess={(ev) => handleProcess(ev)} storeMcu={null} skill={selOrderDetail.jdeServiceType} onHide={(ev) => setSelOrderDetail(null)} /> : "";
